...
namespace WaveTextFormatter
{
    ...
    {
        public Boolean isLineHead = false;
        ...
        public void overrideOption(WaveOptions w)
        {
            switch (w.option)
            {
                ...
                case OptionEnum.AUTO_GEN_TEMP:
                    ...
                    this.filename += this.AutoGenPostfix;
                    break;
                ...
                case OptionEnum.ADD_END_TEMP:
                    ...
                    break;
                case OptionEnum.AUTO_GEN_NEXT_TEMP:
                    this.autoGenPostFixNext = (String)w.arg;
                    break;
            }
        }
        ...
        public String ToFinalString()
        {
            ...
            strb.AppendFormat("{0} cut_volume {1} | cut_mute {2} | mute {3} | auto_gen {4} | add_head {5} | add_end {6}",
                filename, CutVolume, CutMuteDuration, MuteDuration, AutoGenPostfix, AddHead, AddEnd);
